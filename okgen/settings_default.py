...
sys.path.insert(0, os.path.join(PROJECT_ROOT, "okgen"))
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'www.okgen.com']
...
SECRET_KEY = '1n99b8(c5t&amp;5n)cbe)m6em5vi1%@v6--ij_un2quptzip&amp;l+s0'
